package com.lind.mavenspringcore.util;
...
public class ResponseUtil {
    ...
    public static Map<String, Object> resultMap(boolean flag, Integer code, String msg) {
        ...
        Map<String, Object> resultMap = getStringObjectMap(flag, code, msg);
        return resultMap;
    }

    private static Map<String, Object> getStringObjectMap(boolean flag, Integer code, String msg) {
